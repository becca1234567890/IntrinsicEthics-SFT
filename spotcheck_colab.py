...
# Keep in sync with _CAUSAL_SET_C in generate_data_colab.py — update both if vocabulary changes.
_CAUSAL = {
...
# Keep in sync with _RULE_SET_C in generate_data_colab.py — update both if vocabulary changes.
_RULE = {
...
# Keep in sync with _CAUSAL_WORDS_B in generate_data_colab.py — update both if vocabulary changes.
_CAUSAL_WORDS = {
