"""
IntrinsicEthics-SFT — Step 01: Environment Setup

Installs Python dependencies, mounts Google Drive, and verifies that the
required API keys (ANTHROPIC_API_KEY, HF_TOKEN) are present in Colab Secrets.
Re-run this script after switching Colab runtimes (L4 → A100 between steps 3 and 4).

Inputs:
    Colab Secrets: ANTHROPIC_API_KEY, HF_TOKEN

Outputs:
    Installed packages in the active Colab environment
