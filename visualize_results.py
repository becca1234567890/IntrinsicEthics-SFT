# ═══════════════════════════════════════════════════════════════════════════════
# INTRINSIC ETHICS SFT — RESULTS VISUALIZATION
# Reads eval_progress_merged.json, saves sft_experiment_results.png
# No GPU needed. Compatible with Colab non-interactive backend.
# ═══════════════════════════════════════════════════════════════════════════════
